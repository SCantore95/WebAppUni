...
public class StudentsService
{
 public StudentRepository studentRepository { get; set;}= new();
        ...
        public List<Student> GetStudentsFromDatabase()
        {
            ...
            string query = "SELECT Matricola, Department, AnnoDiIscrizione, name, surename, age, gender FROM Student";
            ...
            using (SqlConnection conn = new SqlConnection(ConnectionString))
            {
                ...
                while (reader.Read())
                {
                    Student student = new Student
                    {
                        ...
                        AnnoDiIscrizione = reader["AnnoDiIscrizione"] != DBNull.Value ? Convert.ToInt32(reader["AnnoDiIscrizione"]) : 0,
