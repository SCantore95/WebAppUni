...
namespace UniLIbService
{
    public class DbManager
    {
        ...
        public List<Student> GetStudentsFromDatabase(String matricola)
        {
            ...
            string query = "SELECT Matricola, Department, AnnoDiIscrizione, name, Surename, Age, Gender FROM Student WHERE Matricola = @Matricola";
                        ...
                        else
                        {
                            while (reader.Read())
                            {
                                Student student = new Student
                                {
                                    ...
                                    AnnoDiIscrizione  = reader["AnnoDiIscrizione"] != DBNull.Value
                                    ? new DateTime(Convert.ToInt32(reader["AnnoDiIscrizione"]), 1, 1)  // Usa l'anno per creare un DateTime
                                   : (DateTime?)null,
        ...
        public bool AddStudent(Student newStudent)
        {
            ...
            string query = "INSERT INTO Student (Matricola, Name, Surename, Age, Gender, Department, AnnoDiIscrizione) " +
